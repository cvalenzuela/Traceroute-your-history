...
module.exports = (callback) => {
  ...
  if (fs.existsSync(originalDbPath)) {
    ...
    console.log(`\n-- Browser history path is correct`.green);
        ...
        db.all(query, (err, history) => {
          if (!history) {
            ...
            mkdirp('./history', (err) => {
              ...
              else fs.writeFile("./history/history.json", JSON.stringify(history), (err) => {
    ...
    readDb(); // Just for debug, erase this and uncomment top
